    ...
    <div className="w-full max-w-full overflow-x-clip">
      ...
      <SlideIn direction="top" delay={200} duration={2000} className="z-10 relative">
        <div className="relative ml-32 text-primary-reddish">
          ...
          <p className="text-[38px] text-right mr-48">
            <span className="font-bold"> engineering for everyone</span>
            <br />(even your mom)
          </p>
        </div>
      </SlideIn>
      ...
      {/* Scroll-down button */}
      <div className="z-10 relative flex justify-center mt-16 mb-0">
        <button
        ...
        >
          <span className="text-sm tracking-widest uppercase font-bold">products</span>
